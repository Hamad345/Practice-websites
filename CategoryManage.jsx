...
export default function CategoryManage() {
  ...
  const handleChange = (event) => {
    ...
    navigate(event.target.value); // Navigate to the selected option's path
  };
  ...
  return (
    <>
     ...
     <div className='flex '>
      ...
      <div className='bg-[#E6E6EB] w-52 h-screen  '>
       <div className='fixed'>
   ...
   {/* main start */}
   <div className='bg-[#F2F2F2] ml-[230px] -mt-[470px] w-[1000px] border rounded-[35px] h-[450px]'>
    {/* nav inside */}
    <div className='flex'>
    ...
    <div className='flex ml-6 gap-x-7 '>
     <div className='bg-[red] w-52 h-52  mt-5 border rounded-[35px]'><img src={men} alt='' /><Link to='/CategoryMen'><button className='border rounded-[35px] absolute ml-5 -mt-10 w-12 text-extrabold bg-[#FFFFFF] text-[12px] h-6 '>Men</button></Link></div>
     <div className='bg-[red] w-52 h-52 mt-5 border rounded-[35px]'><img src={women} alt='' /><button className='border rounded-[35px] absolute ml-5 -mt-10 w-14 text-extrabold bg-[#FFFFFF] text-[12px] h-6 '>Women</button></div>
     ...
     <div className='bg-[red] w-52 h-52  mt-5 border rounded-[35px]'><img src={accessories} alt='' /><button className='border rounded-[35px] absolute ml-5 -mt-10 w-20 text-extrabold bg-[#FFFFFF] text-[12px] h-6 '>Accessories</button></div>
     </div>
